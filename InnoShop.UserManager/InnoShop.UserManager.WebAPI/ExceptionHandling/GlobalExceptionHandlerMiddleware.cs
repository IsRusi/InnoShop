    ...
    public class GlobalExceptionHandlerMiddleware
    {
        ...
        private static int MapDomainExceptionToStatusCode(DomainException ex)
        {
            ...
            return ex switch
            {
                ...
                InvalidCredentialsException _ => StatusCodes.Status401Unauthorized,
                InvalidTokenException _ => StatusCodes.Status401Unauthorized,
                AccountNotActiveException _ => StatusCodes.Status403Forbidden,
                EmailNotConfirmedException _ => StatusCodes.Status403Forbidden,
        ...
        private static string ToErrorCode(string typeName)
        {
            ...
            // convert PascalCase to UPPER_SNAKE (e.g., InvalidToken -> INVALID_TOKEN)
